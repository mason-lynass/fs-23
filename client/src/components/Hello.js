function Hello() {
    return (
        <div id="hello">
            ...
            {/* <p> The draft is open!<br/><br/> The next tournament begins on November 10th, so make sure you draft before then!</p> */}
            ...
            <p>Congrats to HeyZee on your Fantasy Sumo victory!</p><p> The new rankings will be announced on December 23rd, so the draft will be open from December 24th - January 12th.</p><p>Thanks for playing everyone!</p>
        </div>
    )
}
