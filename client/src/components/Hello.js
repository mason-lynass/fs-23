function Hello() {
  return (
    <div id="hello">
      ...
      <p>
        The draft is open.
        <br />
        <br /> The next tournament begins on September 13th, so make sure you
        draft before then!
      </p>
  ...
  {/* <p>If you picked someone that's out of the tournament, feel free to email me at mtfujisumo[at]gmail[dot]com with your team name and new pick.</p> */}
      ...
      {/* <p>Congrats to jotasensual on your Fantasy Sumo victory!</p><p> The new rankings will be announced on August 31st, so the draft will be open from September 1st - 12th.</p>
