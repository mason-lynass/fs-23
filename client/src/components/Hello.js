function Hello() {
    return (
        <div id="hello">
            ...
            {/* <p>Congrats to HeyZee on your Fantasy Sumo victory!</p><p> The new rankings will be announced on February 25th, so the draft will be open from February 26th - March 9th.</p><p>Thanks for playing everyone!</p> */}
        </div>
    )
}
